...
func (e ProjectEdges) GameOrErr() (*Game, error) {
	if e.Game != nil {
		return e.Game, nil
...
func (*Project) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case project.FieldDownloadCount, project.FieldFollowCount:
			values[i] = new(sql.NullInt64)
		case project.FieldStatus, project.FieldName, project.FieldDescription, project.FieldSlug:
			values[i] = new(sql.NullString)
		case project.FieldCreatedAt, project.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case project.FieldID, project.FieldGameID, project.FieldProjectTypeID:
...
// QueryGame queries the "game" edge of the Project entity.
func (_m *Project) QueryGame() *GameQuery {
	return NewProjectClient(_m.config).QueryGame(_m)
}

// QueryProjectType queries the "project_type" edge of the Project entity.
func (_m *Project) QueryProjectType() *ProjectTypeQuery {
	return NewProjectClient(_m.config).QueryProjectType(_m)
}
