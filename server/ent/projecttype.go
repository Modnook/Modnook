...
func (e ProjectTypeEdges) GameOrErr() (*Game, error) {
	if e.Game != nil {
		return e.Game, nil
...
func (*ProjectType) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case projecttype.FieldName, projecttype.FieldSlug:
			values[i] = new(sql.NullString)
		case projecttype.FieldCreatedAt, projecttype.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case projecttype.FieldID, projecttype.FieldGameID:
...
func (_m *ProjectType) assignValues(columns []string, values []any) error {
...
func (_m *ProjectType) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryGame queries the "game" edge of the ProjectType entity.
func (_m *ProjectType) QueryGame() *GameQuery {
	return NewProjectTypeClient(_m.config).QueryGame(_m)
}
...
func (_m *ProjectType) Update() *ProjectTypeUpdateOne {
	return NewProjectTypeClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the ProjectType entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *ProjectType) Unwrap() *ProjectType {
...
func (_m *ProjectType) String() string {
