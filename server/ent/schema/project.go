...
func (Project) Fields() []ent.Field {
	return []ent.Field{
		...
		// A de-normalized cached count of the number of downloads for this project
		//
		// This is updated by a trigger on the downloads table
		//
		field.Int("download_count").Default(0),

		// A de-normalized cached count of the number of followers for this project
		//
		// This is updated by a trigger on the project_followers table
		//
		field.Int("follow_count").Default(0),
