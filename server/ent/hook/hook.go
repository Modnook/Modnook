...
import (
	...
	"github.com/modnook/modnook/ent"
)
...
// The ProjectFollowFunc type is an adapter to allow the use of ordinary
// function as ProjectFollow mutator.
type ProjectFollowFunc func(context.Context, *ent.ProjectFollowMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectFollowFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProjectFollowMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProjectFollowMutation", m)
}

// The ProjectReleaseFunc type is an adapter to allow the use of ordinary
// function as ProjectRelease mutator.
type ProjectReleaseFunc func(context.Context, *ent.ProjectReleaseMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectReleaseFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProjectReleaseMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProjectReleaseMutation", m)
}
...
// The ProjectTypeSchemaFunc type is an adapter to allow the use of ordinary
// function as ProjectTypeSchema mutator.
type ProjectTypeSchemaFunc func(context.Context, *ent.ProjectTypeSchemaMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProjectTypeSchemaFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProjectTypeSchemaMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProjectTypeSchemaMutation", m)
}
